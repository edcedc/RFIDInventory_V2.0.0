...
class ExternalAdapter (data: ArrayList<DataBean>) :
    ...
    override fun convert(viewHolder: BaseViewHolder, bean: DataBean) {
        ...
        bean.run {
            ...
            viewHolder.setText(R.id.tv_text, bean.OrderNo + " | " + bean.BorrowName)
            ...
            viewHolder.setText(R.id.tv_title1, "：" + bean.BorrowDate)
            viewHolder.setText(R.id.tv_location, context.getText(R.string.statusName))
            viewHolder.setText(R.id.tv_location1, "：" + bean.BorrowName)
            viewHolder.setText(R.id.tv_epc, context.getText(R.string.ratio))
            viewHolder.setText(R.id.tv_epc1, "：" + bean.Inventory_progress)
            viewHolder.setText(R.id.tv_progress, context.getText(R.string.remarks))
            viewHolder.setText(R.id.tv_progress1, "：" + bean.Remarks)
        }
    }
